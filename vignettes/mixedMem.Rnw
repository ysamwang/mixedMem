...
\begin{document}
\title{Fitting Mixed Membership Models using \texttt{mixedMem}\footnotetext{Special thanks to McKay Curtis and Kevin Lin for providing feedback on package features and usability}}
